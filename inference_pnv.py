...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate PointNetVLAD recall on KITTI.")
    parser.add_argument(
        "--query-file",
        type=str,
...
def main() -> None:
    ...
    query_features, query_key_order = extract_embeddings(
    ...
    db_features, db_key_order = extract_embeddings(
        dataset=db_dataset,
        model=model,
        batch_size=args.batch_size,
        num_workers=args.num_workers,
